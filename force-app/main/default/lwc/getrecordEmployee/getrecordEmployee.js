...
//export default class GetrecordEmployee extends LightningElement {
    ...
    import NAME_FIELD from '@salesforce/schema/Employee11__c.Name';
 
    import DESIGNATION_FIELD from '@salesforce/schema/Employee11__c.Designation__c';
    import GENDER_FIELD from '@salesforce/schema/Employee11__c.Gender__c';
    import EMAIL_FIELD from '@salesforce/schema/Employee11__c.Email__c';
    import USERNAME_FIELD from '@salesforce/schema/Employee11__c.Username__c';
    import PHONE_FIELD from '@salesforce/schema/Employee11__c.Phone_Number__c';
    
    export default class GetRecordEmployee extends LightningElement {
        recordId ="a0CDo000000ol8sMAA";
        employeeId;
